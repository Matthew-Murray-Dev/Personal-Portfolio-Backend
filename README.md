# Personal Portfolio Backend Application
...
| `src/db/`                        | A folder where you will add migration and seed files for your database.                                      |
| `src/errors/`                    | A folder where several functions for handle various errors are located                               |
